  ...
  <tr valign="top">
	...
	<%if action="list" then%><BR>
        ...
        <tr bgcolor='#F2FDFF'>
          ...
          <td colspan="5" bgcolor="#FFFFFF"><input name="RealName" type="text" id="RealName" onKeyDown="next()" size="50" maxlength="50" > 
            按回车\TAB键即可输入下一选项</td>
        </tr>		
		<tr bgcolor="#FFFFFF">
		  <td width="10%" align="right">电话：</td>
		  <td colspan="5"><input name="Mobile" type="text" id="Mobile" onKeyDown="next()" value="" > </td>
		</tr>
		<tr bgcolor='#FFFFFF'>
